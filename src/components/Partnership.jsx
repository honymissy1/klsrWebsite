const Partnership = () =>{
    return(
        <div className="min-h-[400px] h-max mb-10 px-10 w-full" id="partnership">
            ...
            <p className="text-center my-10 text-xl m-auto w-full md:w-[500px]">You can partner with us by sending your seeds to the account numbers below anywhere around the world</p>
            <div className="flex justify-evenly gap-10 flex-wrap">
                <div className="w-max p-5 text-center bg-[#87ab7db1]">
                    <img className="w-[50px] m-auto" src="/images/Zenith-logo.png" alt="" />
                    <h1 className="font-extrabold text-2xl">1229216755</h1>
                    <p className="text-[#435ca5] dark:bg-white">Kingdom Lifestyle & Diamond Charities</p>
                </div>
