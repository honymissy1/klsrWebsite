        ...
        <div className="flex" id="features-container">
            ...
            <div className='flex'>
                    <div className="flex p-10 gap-5 flex-1 flex-wrap lg:w-[50%]" style={{ height: 'auto' }}> 
                            <div dataAos="zoom-in" style={{ height: 'max-content'}} className="rounded p-5 text-center bg-[#880808] text-white min-w-[250px] flex-1 h-auto">
                            <div>
                            ...
                            <div dataAos="fade-right" style={{height: 'max-content'}} className="rounded p-5 text-center bg-[#880808] text-white flex-1 min-w-[250px] h-auto">
                            <div>
                                <i class="fa-solid fa-people-pulling text-4xl"></i>
