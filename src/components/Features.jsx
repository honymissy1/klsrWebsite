            ...
            <div className='flex'>
                    <div className="flex p-10 gap-5 flex-1 flex-wrap lg:w-[50%]" style={{ height: 'auto' }}> 
                            ...
                            <div>
                                ...
                                <h1 className="p-3 font-bold text-lg"> Uplifting Content and Positive Messages</h1>

                            </div>
    
                                <p className="py-3 text-sm font-bold text-[#ddd]">Inspiring Messages for Daily Life</p>
                
                                <p className="text-xs text-center text-[#ddd]"> <span className='text-[#FFD700] font-extrabold'>KLSR</span>  offers constant uplifting content and positive messages, fostering hope, encouragement, and guidance for navigating life's challenges</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-xs text-center text-[#ddd]">Yoruba Christian radio stations preserve cultural and spiritual heritage, providing programmes in the Yoruba language that resonates deeply with listeners, reinforcing faith and identity.</p>
                            </div>
                    </div>
